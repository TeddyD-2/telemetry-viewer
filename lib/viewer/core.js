...
import { SESSION_DASH } from './palette.js';
...
export function createViewer(root, opts = {}){
  ...
  /* Colour follows the lap, not its position in the current selection. A slot is
     ...
     survivors of a change keep the hue they had. Capped at 8: past the fixed order there
     is no 9th hue that stays distinguishable under colour-vision deficiency. */
  const MAX_OVERLAY = 8;
